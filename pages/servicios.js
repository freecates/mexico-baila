  ...
  <MainLayout mainlayout>
    ...
    <BasicPageStyles>
      ...
      <div className="hero no--no-height">
        <h2 className="subtitle">{props.data.description}</h2>
        <p className="lead">{props.data.content.firstLead}</p>
        <hr />
        <h2 className="subtitle">{props.data.content.title}</h2>
        <p className="lead">{props.data.content.secondLead}</p>
...
Servicios.getInitialProps = async function() {
